...
*
*                               NET_IPv6_ERR_NONE                   DAD process finish successfully,
*                               NET_IPv6_ERR_DAD_DISABLED           DAD is disabled.
*                               NET_IPv6_ERR_ADDR_NOT_FOUND         IPv6 addrs obj not found.
*                               NET_IPv6_ERR_AUTO_CFG_DISABLED      IPv6 Auto-Cfg disabled.
*                               NET_IPv6_ERR_DAD_FAULT              DAD process faulted.
*                               NET_IPv6_ERR_ADDR_CFG_IN_PROGRESS   DAD in progress.
*                               NET_IPv6_ERR_ADDR_CFG_DUPLICATED    DAD finish with add duplication detected.
*
*                               ----------- RETURNED BY NetIPv6_DAD_SignalWait() : ------------
*                               See NetIPv6_DAD_SignalWait() for additional return error codes.
*
                    ...
                    NET_ERR                 *p_err)
{
    ...
    switch (addr_cfg_type) {
        case NET_IPv6_ADDR_CFG_TYPE_STATIC_BLOKING:
             p_dad_obj->NotifyComplEn = DEF_YES;
             break;


        case NET_IPv6_ADDR_CFG_TYPE_STATIC_NO_BLOKING:
    ...
    if (addr_cfg_type == NET_IPv6_ADDR_CFG_TYPE_STATIC_BLOKING) {

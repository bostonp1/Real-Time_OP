                              ...
                              NET_ERR  *p_err)
{
    ...
    switch (*p_err) {
        case NET_IF_ERR_NONE:
             NET_CTR_STAT_INC(Net_StatCtrs.IFs.Ether.IF_802xCtrs.RxPktCtr);
             break;


        case NET_ERR_RX:
                                                                /* See Note #1.                                             */
             NET_CTR_ERR_INC(Net_ErrCtrs.IFs.Ether.IF_802xCtrs.RxPktDisCtr);
             break;
                              ...
                              NET_ERR  *p_err)
{
    ...
    if (p_buf == (NET_BUF *)0) {
        ...
        NET_CTR_ERR_INC(Net_ErrCtrs.IFs.Ether.TxNullPtrCtr);
       *p_err = NET_ERR_TX;
        return;
    }
#endif
